...
async def _register_with_retry(max_attempts: int = 10, delay: float = 2.0) -> None:
    ...
    info = {
        ...
        "version": "1.0",
        "description": "Specialist data protection and privacy attorney for GDPR/CCPA questions",
        "tasks": ["privacy_question"],
        "endpoint": AGENT_ENDPOINT,
        "tags": ["privacy", "gdpr", "ccpa", "data-protection", "data-breach"],
    }
...
async def main() -> None:
    ...
    agent_card = AgentCard(
        name="Privacy Agent",
        description="Specialist data protection and privacy attorney for GDPR/CCPA and data-breach questions",
        url=AGENT_ENDPOINT,
        version="1.0.0",
        ...
        skills=[
            AgentSkill(
                ...
                description=(
                    "Answer questions about data protection law, GDPR/CCPA obligations, "
                    "data breach notification, cross-border transfers, and privacy fines."
                ),
